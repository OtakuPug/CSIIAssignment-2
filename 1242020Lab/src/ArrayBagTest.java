...
public class ArrayBagTest {
	...
	public void testAdd() {
		...
		int currentSize = stringBag.getCurrentSize();
		for(int i = 0; i < (ARRAYBAG_DEFAULT_CAPACITY-currentSize); i++) {
			assertTrue(stringBag.add("9"));
		}
		
		assertTrue(stringBag.contains("9"));
		// No more additions allowed
		assertFalse(stringBag.add("9"));
	}
